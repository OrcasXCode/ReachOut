        ...
        {userRole=='BUSINESS' ? <div className="min-w-0 flex-1">
            ...
            <div className="flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap sm:space-x-6 mb-5">
              <div className="mt-2 flex items-center text-sm text-gray-500">
                <Rating value={userBusinessDetails?.totalRating ?? 0} readonly />
              </div>
        ...
        {userRole=="BUSINESS" ? <div>
          ...
          <div className="mb-6 flex flex-col items-end gap-4 md:flex-row mt-5">
            <div className="w-full">
              ...
              <p className="w-full placeholder:opacity-100 focus:border-t-primary border-t-blue-gray-200">{userBusinessDetails?.name || "Loading..."}</p>
            </div>
            <div className="w-full">
              <Typography
                variant="small"
              ...
              <p className="w-full placeholder:opacity-100 focus:border-t-primary border-t-blue-gray-200">{String(userBusinessDetails?.verified) || "Loading..."}</p>
            </div>
          </div>
          <div className="mb-6 flex flex-col items-end gap-4 md:flex-row">
            <div className="w-full">
          ...
          <div className="mb-6 flex flex-col items-end gap-4 md:flex-row">
            <div className="w-full">
              ...
              <p className="w-full placeholder:opacity-100 focus:border-t-primary border-t-blue-gray-200">
              {userBusinessDetails?.address || "Loading..."}
              </p>
            </div>
            <div className="w-full">
              <Typography
          ...
          <div className="mb-6 flex flex-col items-start gap-4 md:flex-row">
            <div className="flex-1 max-w-[50%]">
              ...
              <p className="w-full placeholder:opacity-100 focus:border-t-primary border-t-blue-gray-200 ">{userBusinessDetails?.about || "Loading..."}</p>
            </div>
            <div className="w-[50%]">
              <Typography
                variant="small"
              ...
              <p className="w-full placeholder:opacity-100 focus:border-t-primary border-t-blue-gray-200">{String(userBusinessDetails?.totalRating) || "Loading..."}</p>
            </div>
          </div>
          <div className="mb-6 flex flex-col items-end gap-4 md:flex-row">
            <div className="w-full">
          ...
          <div className="mb-6 flex flex-col items-end gap-4 md:flex-row">
            <div className="w-full">
              ...
              <a href={userBusinessDetails?.website || "Loading..."} className="font-medium text-blue-600 dark:text-blue-500 hover:underline ease-in-out">Visit Site</a>
            </div>
            <div className="w-full">
              <Typography
                variant="small"
          ...
          <section className="py-15 relative">
              <div className="w-full max-w-7xl px-4 md:px-5 lg:px-6 mx-auto">
                  <div className="">
                      ...
                      <div className="grid grid-cols-12 mb-11">
                          <div className="col-span-12 xl:col-span-4 flex mx-auto">
                            <div className="box flex flex-col gap-y-4 w-full max-xl:max-w-3xl mx-auto">
                                <Image 
                                  src='./report.svg' 
                                  alt="Report Flag" 
