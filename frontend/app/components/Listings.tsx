...
export default function Listings() {
  ...
  return (
    ...
    {businesses.map((business) => (
      <li key={business.businessEmail} className="grid grid-cols-3 sm:grid-cols-1 border p-5 rounded-md">
            ...
            <div className="col-span-2 sm:col-span-1">
             <div className="flex flex-row  items-center justify-between mb-2">
              ...
              <div>
                ...
                >
                  <p className="text-xs text-gray-500 col-span-full">{business.description}</p>
                </div>
