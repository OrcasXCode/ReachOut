...
const businesses: {
  ...
  distance: string;
  imageUrl: string;
  status: BusinessStatus;  // Explicitly typing the status as "Open" | "Closed"
}[] = [
  {
    businessName: 'Glamour Beauty Salon',
    description: 'A premium beauty salon offering a wide range of services including bridal makeup, mehndi, and nail art. Our expert stylists ensure you look your best for any occasion.',
    businessEmail: 'glamourbeauty@example.com',
    phoneNumber: '+91 94290XXXX46',
    distance: '1.5 km',
    imageUrl:
  ...
  {
    businessName: 'Elegant Bridal Studio',
    description: 'Specializing in bridal makeup and mehndi designs, we create unforgettable looks for your special day. Our team is dedicated to making you feel like a queen.',
    businessEmail: 'elegantbridal@example.com',
    phoneNumber: '+91 94290XXXX47',
    distance: '4 km',
    imageUrl:
  ...
  {
    businessName: 'Urban Nail Bar',
    description: 'A modern nail art studio offering trendy designs and premium nail care services. Perfect for those who want to express their style through their nails.',
    businessEmail: 'urbannailbar@example.com',
    phoneNumber: '+91 94290XXXX48',
    distance: '2 km',
    imageUrl:
  ...
  },
  {
    ...
    description: 'Indulge in our luxurious spa treatments designed to rejuvenate your mind and body. From facials to massages, we offer a holistic wellness experience.',
    businessEmail: 'luxuryspa@example.com',
    phoneNumber: '+91 94290XXXX49',
    distance: '3 km',
    imageUrl:
  ...
  {
    businessName: 'Creative Makeup Studio',
    description: 'Our makeup artists specialize in creative and artistic makeup looks for photoshoots, events, and special occasions. Let us bring your vision to life.',
    businessEmail: 'creativemakeup@example.com',
    phoneNumber: '+91 94290XXXX50',
    distance: '5 km',
    imageUrl:
  ...
  {
    businessName: 'Hair & Beyond',
    description: 'From haircuts to hair treatments, we offer a wide range of services to keep your hair healthy and stylish. Our stylists are trained in the latest trends.',
    businessEmail: 'hairbeyond@example.com',
    phoneNumber: '+91 94290XXXX51',
    distance: '1 km',
    imageUrl:
...
export default function Listings() {
  ...
  return (
    ...
    {businesses.map((business) => (
      <li key={business.businessEmail} className="flex justify-between border p-5 rounded-md">
        <div className="flex flex-col min-w-0  gap-x-4">
          <div className="min-w-0 flex flex-row justify-between ">
            <div>
             <div className="flex flex-row  items-center justify-between mb-2">
              <h1 className="font-semibold text-gray-900">{business.businessName}</h1>
            ...
            {/*Business Info */}
            <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end space-y-1.5">
          ...
          <div className="flex flex-row p-0 items-center justify-center gap-1 mt-2">
            ...
            {/* <div className="w-[40%] flex items-center justify-center rounded-md">
              <Carousel/>
            </div> */}
          </div>
        </div>  
