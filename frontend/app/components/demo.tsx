        ...
        <div className="space-y-12 max-w-7xl p-3">  
            ...
            {userRole==="Business" ?
                <div className="border-b border-gray-900/10 pb-12">
                    ...
                    <p className="mt-1 text-sm/6 text-gray-600">Use your correct business information to avoid any furthur inconvenience.</p>
            ...
            <div className="mt-10 space-y-10">
                ...
                <p className="mt-1 text-sm/6 text-gray-600">These are delivered via app notifications to your mobile phone.</p>
                <div className="mt-6 space-y-6">
